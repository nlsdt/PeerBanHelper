...
public enum Lang {
    ...
    LAB_EXPERIMENT_FILL_MISSING_DATA_IN_TRAFFIC_SUMMARY_TITLE,
    LAB_EXPERIMENT_FILL_MISSING_DATA_IN_TRAFFIC_SUMMARY_DESCRIPTION,
    GUI_TABBED_WEBUI,
    JCEF_BROWSER_UNSUPPORTED_PLATFORM,
    JCEF_BROWSER_UNSUPPORTED_EXCEPTION,
    JCEF_DOWNLOAD_TITLE,
    JCEF_DOWNLOAD_DESCRIPTION,
    GUI_COMMON_CANCEL,
    JCEF_DOWNLOAD_UNZIP_DESCRIPTION,
    IPDB_DOWNLOAD_TITLE,
    IPDB_DOWNLOAD_DESCRIPTION,
    PBH_PLUS_THANKS_FOR_DONATION_GUI_TITLE,
    LAB_EXPERIMENT_MAC_FLATLAF_THEME_TITLE,
    LAB_EXPERIMENT_MAC_FLATLAF_THEME_DESCRIPTION,
    GUI_TITLE_DEBUG,
    ...
    CRASH_MANAGER_GUI_RELATED_TITLE,
    CRASH_MANAGER_GUI_RELATED_DESCRIPTION,
    GUI_PROGRAM_SWITCH_TO_SWT,
    GUI_PROGRAM_SWITCH_TO_SWING,
    GUI_PROGRAM_SWITCH_TO_AUTO,
    ...
    DOWNLOADER_FAILED_STOP_TORRENT,
    DOWNLOADER_FAILED_START_TORRENT,
    BTN_MQTT_CONNECTED,
    BTN_MQTT_RECONNECTED,
    BTN_MQTT_DISCONNECTED,
    MODULE_ACTIVE_MONITORING_SPEED_LIMITER_DISABLED,
    MODULE_ACTIVE_MONITORING_SPEED_LIMITER_UNEXCEPTED_ERROR,
    DATABASE_UPGRADING_RECORDS,
    ...
    GUI_CLEAR_LOGS,
    GUI_QT6_WAITING_EXTRACTING,
    GUI_QT6_WAITING_INIT,
    GUI_QT6_NATIVES_MISSING,
    ...
    CRASH_MANAGER_UNEXPECTED_SHUTDOWN_TITLE,
    CRASH_MANAGER_UNEXPECTED_SHUTDOWN_DESCRIPTION,
    CRASH_MANAGER_FREQUENT_CRASHES_TITLE,
    CRASH_MANAGER_FREQUENT_CRASHES_DESCRIPTION,
    BOOT_TIME,
    ECOMODE_FAILED,
    JBR_REQUIRED_TITLE,
    ...
    BACKGROUND_TASK_EXCEPTION_TITLE,
    BACKGROUND_TASK_EXCEPTION_DESCRIPTION,
    DOWNLOADER_FAILED_SAVE_BT_PROTOCOL_PORT,
    DOWNLOADER_FAILED_RETRIEVE_BT_PROTOCOL_PORT,
    PORTMAPPER_SCANNING, PORTMAPPER_SCANNED,
    BTSTUN_RESTART,
    BTSTUN_ON_TUNNEL_CLOSE,
    BTSTUN_ON_TUNNEL_CREATED,
    BTSTUN_FORWARDER_EXCEPTION,
    BTSTUN_UNABLE_START,
    BTSTUN_MODIFY_DOWNLOADER_BT_PORT,
    BTSTUN_TUNNEL_CREATE_SUCCESSFULLY,
    BACKGROUND_TASK_NOT_FOUND,
    BACKGROUND_TASK_CANNOT_CANCEL,
    BACKGROUND_TASK_CANCEL_REQUESTED,
    BACKGROUND_TASK_PRINT_TITLE,
    BACKGROUND_TASK_PRINT_ITEM_RUNNING,
    BACKGROUND_TASK_PRINT_ITEM_ERROR, BACKGROUND_TASK_NAME_UPDATE_NAT_STATUS, AUTOSTUN_RESTARTED, AUTOSTUN_DOWNLOADER_NOT_EXISTS, AUTOSTUN_DOWNLOADER_TUNNEL_NOT_EXISTS, AUTOSTUN_DOWNLOADER_TUNNEL_FORWARDER_NOT_EXISTS, AUTOSTUN_DOWNLOADER_TUNNEL_UPDATE_PORT_FAILED, AUTOSTUN_DOWNLOADER_TUNNEL_UNREGISTERED, BTSTUN_RESTART_FAILED, BTSTUN_FORWARDER_CREATING, BTSTUN_SHUTDOWN_DOWNLOADER_OFFLINE, BTSTUN_SHUTDOWN_DOWNLOADER_ONLINE, AUTOSTUN_CONFIG_REAPPLIED, PBH_LICENSE_PARSE_FAILED, PBH_LICENSE_KEY_DELETED, PBH_LICENSE_KEY_DELETE_FAILED_NOT_EXISTS, PBH_LICENSE_KEY_EXPIRED, PBH_LICENSE_KEY_REVOKED, PBH_PLUS_FREE_LICENSE_DENIED_EXISTS, POW_CAPTCHA_SERVER_NOT_FOUND, POW_CAPTCHA_SERVER_VERIFY_FAILED, BGTASK_TITLE_EMPTY, BGTASK_WEBSOCKET_TASK_NOT_FOUND;
